...
function [b, bas1, nonbas1, zeta, isFinal, isUnbounded, newEtaFile] = pivotWithEtaFactors(A, b, c, bas, nonbas, etaFile, optimum)
...
%% choose the largest index for our entering variable. ##this is one of the things we'll change up in step 2
