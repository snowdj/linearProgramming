...
%% test the greedy rule

function [b, bas1, nonbas1, zeta, isFinal, isUnbounded, newEtaFile] = pivotGreedy(A, b, c, bas, nonbas, etaFile, optimum)
...
%% Search for the leaving variable, looking for the largest increase to the objective
    for i = 1:m
        if (Ajhat(i) < 0)
